          ...
          <div className="lg:col-span-7 flex flex-col justify-between gap-8 rounded-3xl border border-border/60 bg-card/40 p-8 lg:p-12 card-glow">
            <div>
              ...
              <h1 className="mt-6 font-heading text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl">
                Flawless Access. <br />
                <span className="text-gradient">Unbreakable Control.</span>{" "}
                <br />
                Zero Long Queues.
              </h1>
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
                ...
                ,{" "}
                <span className="font-medium text-foreground">Organizers</span>,
                and <span className="font-medium text-foreground">Guests</span>{" "}
                seamlessly. Accelerate entry with signed HMAC QR passes,
                2.5-second scans, and robust offline resilience.
              </p>
            </div>
              ...
              <div className="space-y-3 font-mono text-xs">
                <div className="p-3 rounded-xl bg-navy-900/80 border border-border/40 space-y-1">
                  ...
                  <div className="text-white font-bold">
                    Babatunde Raji · EVT-TBK88
                  </div>
                  <div className="text-[10px] text-muted-foreground">
                    Scan duration: 2.1s · Verified by Gate Camera Agent
                  </div>
                </div>
                ...
                <div className="p-3 rounded-xl bg-navy-900/80 border border-border/40 space-y-1">
                  ...
                  <div className="text-white font-bold">
                    Eko Convention Centre · Main Arena
                  </div>
                  <div className="text-[10px] text-muted-foreground">
...
/* ---------------- MEET MUSA AI STORYTELLING SECTION ---------------- */
function MeetMusaAiSection({
  onNavigate,
}: {
  onNavigate: (v: ViewRoute) => void;
}) {
  return (
          ...
          <div className="grid gap-8 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-base sm:text-lg leading-relaxed text-muted-foreground">
                Inspired by the iconic Nigerian proverb{" "}
                <em className="text-foreground font-medium">
                  "Wetin Musa no go see for gate?"
                </em>{" "}
                — meaning the gatekeeper who has seen it all, experience,
                vigilance, and unbreakable watchfulness.
              </p>

              <p className="text-sm sm:text-base leading-relaxed text-muted-foreground">
                Some gates end in bottleneck queues. Others in fake tickets or
                gate crashes. Around here,{" "}
                <strong className="text-foreground">Musa AI</strong> watches
                every entrance, flags suspicious duplicate scans in real-time,
                predicts venue congestion, and instructs ushers before queues
                build up.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 rounded-2xl border border-border/60 bg-navy-900/60 space-y-1">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Validates cryptographically signed HMAC passes instantly.
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-border/60 bg-navy-900/60 space-y-1">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Predicts gate lane bottlenecks 12 minutes before congestion
                    hits.
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3 font-mono text-xs">
                  <div className="p-3 rounded-2xl bg-card/60 border border-border/40 space-y-1">
                    ...
                    <p className="text-foreground">
                      "Gate B is becoming congested. 48 guests arriving per
                      min."
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-2xl bg-primary/20 border border-primary/40 space-y-1">
                    ...
                    <p className="text-foreground font-bold">
                      Open Overflow Gate D (Lane #03).
                    </p>
                    <p className="text-[11px] text-muted-foreground">
                      Predicted queue reduction: <strong>41%</strong> in 4 mins.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-2xl bg-card/60 border border-border/40 space-y-1">
                    ...
                    <p className="text-foreground">
                      "Musa flagged 1 duplicate QR pass attempt. Re-entry
                      blocked."
                    </p>
                  </div>
                </div>
  ...
  const audiences = [
    {
      ...
      title: "Event Centres",
      description:
        "Control every gate, lane, and entry point from a single operational layer.",
      features: [
    ...
    },
    {
      ...
      title: "Organizers",
      description:
        "Build events, invite teams, and delegate access without engineering support.",
      features: [
    ...
    },
    {
      ...
      title: "Guests",
      description:
        "Receive secure, wallet-ready passes that scan in under three seconds.",
      features: [
        "HMAC-signed QR passes",
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Gatehouse aligns the three parties that make an event run: the
            venue, the organizer, and the guest.
          </p>
        </div>
  ...
  const paths = [
    {
      ...
      title: "Direct Import",
      description:
        "Sync existing guest lists via API or CSV. Bulk-import thousands of VIPs in seconds.",
    },
    {
      step: "02",
      title: "Delegated Access",
      description:
        "Let sponsors, vendors, and venue teams issue passes within your established access policies.",
    },
    {
      step: "03",
      title: "Public Link",
      description:
        "Open a controlled public registration page with real-time capacity cap enforcement.",
    },
  ];
    ...
    <section className="border-y border-border/40 bg-secondary/30 px-6 py-16 lg:py-24">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Gatehouse provides complete operational freedom for any event
            workflow.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {paths.map((path) => (
            ...
            >
              <span className="font-heading text-5xl font-bold text-border/80">
                {path.step}
              </span>
  ...
  const features = [
    {
      ...
      description:
        "Every pass is cryptographically signed and validated locally at the gate in <1ms.",
    },
    {
      icon: Zap,
      title: "2.5-Second Scan Velocity",
      description:
        "Optimized scanning pipeline built for high-throughput entry lanes and zero queues.",
    },
    {
      icon: ShieldCheck,
      title: "Offline Mesh Resilience",
      description:
        "Gates keep validating even when network drops completely. Sync resumes automatically.",
    },
    {
      icon: BarChart3,
      title: "Operational Analytics",
      description:
        "Real-time capacity, VIP ratio flow rates, and anomaly detection for event control.",
    },
    {
      icon: Lock,
      title: "Role-Based Access Control",
      description:
        "Granular roles for Organizers, Venue Managers, Ushers, Security, and Guests.",
    },
    {
      icon: Radio,
      title: "Live Entry Stream",
      description:
        "Monitor every gate from a centralized control room with instant alerts.",
    },
  ];
        ...
        <div className="rounded-3xl border border-border/60 bg-card/40 p-8 lg:p-12 card-glow space-y-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-muted-foreground">
              See how Gatehouse 2.5-second scans clear attendee crowds in record
              time.
            </p>
          </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm font-heading font-bold">
                  ...
                  <span className="text-[#5cbdb9]">
                    {guestsCount.toLocaleString()} Guests
                  </span>
                </div>
                <input
                  type="range"
              ...
              <div className="text-xs font-mono text-muted-foreground border-t border-border/40 pt-3 space-y-1">
                <div>
                  ...
                  <strong className="text-foreground">
                    {Math.round(totalThroughputPerMin)} guests/min
                  </strong>
                </div>
                <div>
                  Per Lane:{" "}
                  <strong className="text-foreground">24 guests/min</strong> (at
                  2.5s/scan)
                </div>
              </div>
            </div>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-3xl border border-border/60 bg-primary/10 px-8 py-16 lg:px-16 lg:py-20">
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Start issuing signed passes and controlling gates in minutes — not
              weeks.
            </p>
