import type { EventCentre, EventItem, Booking, Delegation, Guest } from '../types';
...
export const MOCK_EVENT_CENTRES: EventCentre[] = [
  ...
  },
  {
    ...
    description: 'Executive convention centre located in the heart of Abuja for summits and VIP banquets.',
    ...
    amenities: ['Presidential Suite', 'Helipad Access', 'Fiber Optic Wi-Fi', 'Security Screening'],
    status: 'approved',
  },
];
